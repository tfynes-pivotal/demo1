...
k8s_custom_deploy(
    'demo1',
    apply_cmd="tanzu apps workload apply -f demo1-workload.yaml --update-strategy replace --debug --live-update" +
              " --local-path " + LOCAL_PATH +
              " --namespace " + NAMESPACE +
              " --wait-timeout " + WAIT_TIMEOUT +
              " --type " + TYPE +
              " --yes --output yaml",
    delete_cmd="tanzu apps workload delete -f demo1-workload.yaml --namespace " + NAMESPACE + " --yes",
